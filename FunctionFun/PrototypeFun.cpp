...
double getGradePoint(string);
int getNumberCredits(string);
double computeWeightedCredits(double, double, double, int, int, int);
int computeTotalCredits(int, int, int);
double computeGPA(double, int);
void displayGPA(double);
